          ...
          <div class="ps-lg-10 mt-6 mt-md-0">
            ...
            <div class="mt-3 row justify-content-start g-2 align-items-center">
              ...
              <div class="col-xxl-4 col-lg-4 col-md-5 col-5 d-grid">
                <!-- button -->
                <!-- btn --> <a href="cart.php?id=<?=$row['id']?>" type="button" class="btn btn-primary">Add to Cart</a>
              </div>
                        ...
                        <div class="ms-5">
                          ...
                          <div>
                            <div class="border icon-shape icon-lg border-2 ">
                              <!-- img --><img src="https://freshcart.codescandy.com/assets/images/products/product-img-1.jpg" alt=""
                                class="img-fluid ">
                            </div>
                            <div class="border icon-shape icon-lg border-2 ms-1 ">
                              <!-- img --><img src="https://freshcart.codescandy.com/assets/images/products/product-img-2.jpg" alt=""
                                class="img-fluid ">
                            </div>
                            <div class="border icon-shape icon-lg border-2 ms-1 ">
                              <!-- img --><img src="https://freshcart.codescandy.com/assets/images/products/product-img-3.jpg" alt=""
                                class="img-fluid ">
                            </div>
