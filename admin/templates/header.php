    ...
    <div>
                            ...
                            <div data-simplebar style="height: 250px;">
                                ...
                                <ul class="list-group list-group-flush notification-list-scroll fs-6">
                                    ...
                                    <li class="list-group-item px-5 py-4 list-group-item-action active">
                                        <a href="#!" class="text-muted">
                                            <div class="d-flex">
                                           <img src="https://static.vecteezy.com/system/resources/previews/000/439/863/original/vector-users-icon.jpg" alt="" class="avatar avatar-md rounded-circle ">
                                           <div class="ms-4">
                                           <p class="mb-1">
        ...
        <li class="dropdown ms-4">
            <a href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/7/72/Avatar_icon_green.svg/1024px-Avatar_icon_green.svg.png" width="10%" alt="" class="avatar avatar-md rounded-circle">
            </a>
            ...
            <div class="dropdown-menu dropdown-menu-end p-0">
                    ...
                    <div class="lh-1 px-5 py-4 border-bottom">
                        <h5 class="mb-1 h6">ShopThur Admin</h5>
                        <small>shopthur@email.com</small>
                    </div>
