				...
				<div class="row w-100 align-items-center gx-lg-2 gx-0">
					<div class="col-xxl-2 col-lg-3">
						<a class="navbar-brand d-none d-lg-block" href="index.php">
							<img src="assets/images/shopthur.png" width="80%" alt="eCommerce HTML Template">

						</a>
						<div class="d-flex justify-content-between w-100 d-lg-none">
							<a class="navbar-brand" href="index.php">
								<img src="assets/images/shopthur.png" width="50%"
					...
					<div class="col-md-2 col-xxl-1 text-end d-none d-lg-block">
						...
						<div class="list-inline">
							...
							<div class="list-inline-item">
								...
								<a class="text-muted position-relative " href="#" role=""
									aria-controls="offcanvasRight">
									<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"
										fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
			...
			<div class="container px-0 px-md-3">
				<div class="dropdown me-3 d-none d-lg-block">
					...
					<ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
						<li><a class="dropdown-item" href="produk.php">Fruits & Vegetables</a></li>
						<li><a class="dropdown-item" href="produk.php">Snacks & Munchies</a></li>
						<li><a class="dropdown-item" href="produk.php">Bakery & Biscuits</a></li>
						<li><a class="dropdown-item" href="produk.php">Cold Drinks & Juices</a></li>
						<li><a class="dropdown-item" href="produk.php">Instant Food</a></li>
						<li><a class="dropdown-item" href="produk.php">Coll Drink & Juices</a></li>
					</ul>
				</div>
				<div class="offcanvas offcanvas-start p-4 p-lg-0" id="navbar-default">
					<div class="d-flex justify-content-between align-items-center mb-2 d-block d-lg-none">
						<a href="index.php"><img
								src="assets/images/shopthur.png" width="50%"
							...
							<div class="card card-body">
								<ul class="mb-0 list-unstyled">
									<li><a class="dropdown-item"
											href="https://freshcart.codescandy.com/pages/shop-grid.html">Dairy, Bread &
											Eggs</a></li>
									<li><a class="dropdown-item"
											href="https://freshcart.codescandy.com/pages/shop-grid.html">Snacks &
											Munchies</a></li>
									<li><a class="dropdown-item"
											href="https://freshcart.codescandy.com/pages/shop-grid.html">Fruits &
											Vegetables</a></li>
									<li><a class="dropdown-item"
											href="https://freshcart.codescandy.com/pages/shop-grid.html">Cold Drinks &
											Juices</a></li>
									<li><a class="dropdown-item"
											href="https://freshcart.codescandy.com/pages/shop-grid.html">Breakfast &
											Instant Food</a></li>
									<li><a class="dropdown-item"
											href="https://freshcart.codescandy.com/pages/shop-grid.html">Bakery &
											Biscuits</a></li>
									<li><a class="dropdown-item"
											href="https://freshcart.codescandy.com/pages/shop-grid.html">Chicken, Meat &
											Fish</a></li>
								</ul>
							</div>
						</div>
		...
		<div class="modal-dialog modal-dialog-centered">
			<div class="modal-content p-4">
				<div class="modal-header border-0">
					<h5 class="modal-title fs-3 fw-bold" id="userModalLabel">Sign In Admin</h5>
				...
				<div class="modal-body">
					<form>
						<div class="mb-3">
							...
							<input type="text" class="form-control" id="fullName" placeholder="Enter Your Username"
								required="">
						</div>
						...
						<a href="admin/index.php" type="submit" class="btn btn-primary">Sign In</a>
					</form>
				</div>
			</div>
		</div>
						...
						<div data-simplebar style="height:300px;">
							<div class="list-group list-group-flush">
								...
								<a href="#"
									...
									<span>Bandung</span><span>Min:7K</span></a>
								<a href="#"
									class="list-group-item d-flex justify-content-between align-items-center px-2 py-3 list-group-item-action">
									<span>Bogor</span><span>Min:5K</span></a>
								<a href="#"
									class="list-group-item d-flex justify-content-between align-items-center px-2 py-3 list-group-item-action">
									<span>Bekasi</span><span>Min:9K</span></a>
								<a href="#"
									class="list-group-item d-flex justify-content-between align-items-center px-2 py-3 list-group-item-action">
									<span>Depok</span><span>Min:4K</span></a>
								<a href="#"
									class="list-group-item d-flex justify-content-between align-items-center px-2 py-3 list-group-item-action">
									<span>Cirebon</span><span>Min:6K</span></a>
								<a href="#"
									class="list-group-item d-flex justify-content-between align-items-center px-2 py-3 list-group-item-action">
									<span>Garut</span><span>Min:8K</span></a>
