...
<a href=" " class="chat-sticky" target="#"><i data-feather=" "></i> Chat</a>
		...
		<div class="container">
				...
				<div class="row align-items-center">
					...
					<div class="col-lg-7 mt-4 mt-md-0">
						<ul class="list-inline mb-0 text-lg-end text-center">
							<li class="list-inline-item mb-2 mb-md-0 text-dark">Get deliveries with ShopThur Indonesia</li>
			...
			<div class="border-top py-4">
				<div class="row align-items-center">
					<div class="col-md-6"><span class="small text-muted">Copyright 2023 © ShopThur Indonesia eCommerce. All rights reserved. Powered by <a
								href="https://instagram.com/story.thur">Xythur</a>.</span></div>
					<div class="col-md-6">
						<ul class="list-inline text-md-end mb-0 small mt-3 mt-md-0">
							<li class="list-inline-item text-muted">Follow us on</li>
							<li class="list-inline-item me-1">
								<a href="https://instagram.com/story.thur" class="btn btn-xs btn-social btn-icon"> <svg
